...
This project applies unsupervised machine learning methods to SEM-EDS spectrum imaging data to identify chemically distinct domains associated with zinc soap formation in oil paint systems. It was developed and completed within the context of Northwestern University's MSE 465: Advanced Electron Microscopy & Diffraction course, under the guidance of Prof. Roberto dos Reis.
...
The .rpl files contain metadata and header information necessary for interpreting spectral data. The .raw.gz files contain the compressed hyperspectral data cube. Checksum files are included to verify data integrity.
...
1. clone this repository to your local machine
	...
	git clone https://github.com/eliseetrheim/ZincSoap_ML.git
...
3. Download the dataset separately (see *About the Dataset* section) and place all downloaded files inside a local  `data_raw/` directory that (not tracked by Git). 
